...
public final class MathUtil
{
	 ...
	 * @param l the vector to be normalized
	 * @return returns a new vector representing the normalized
	 * version of the passed vector
	 */
	public static double[] normalize(double[] l)
	{
		double mag = magnitude(l);
		return new double[]{l[0]/mag, l[1]/mag};
	}
}
